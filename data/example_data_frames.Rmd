...
ggplot(practice_df, aes(x = Sample_Date, y = K, color = Sample_ID)) + geom_line(show.legend = FALSE) +
        labs(x = "Year", y = "Potassium concentration (mg/l)") + geom_text_repel(data = data_ends, size = 5,  aes(label = Sample_ID), show.legend = FALSE)
```
